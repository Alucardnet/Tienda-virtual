        ...
        <div class="col-md-3">
            <div class="tile p-0">
                <ul class="nav flex-column nav-tabs user-tabs">
                    <li class="nav-item"><a class="nav-link active" href="#user-timeline" data-bs-toggle="tab">Datos personales</a></li>
                    <li class="nav-item"><a class="nav-link" href="#user-settings" data-bs-toggle="tab">Datos fiscales</a></li>
                    <li class="nav-item"><a class="nav-link" href="#datos" data-bs-toggle="tab">Pagos</a></li>
                </ul>
            </div>
        </div>
        <div class="col-md-9">
                ...
                <div class="tab-pane active" id="user-timeline">
                    <div class="timeline-post">
                        <div class="post-media">
                            <div class="content">
                                <h5>DATOS PERSONALES <button class="btn btn-sm btn-info" type="button" onclick="openModalPerfil();"><i class="bi bi-pencil-fill"></i></button></h5>
                            </div>
                        </div>
