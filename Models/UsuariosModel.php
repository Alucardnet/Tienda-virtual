...
class UsuariosModel extends Mysql
{
    ...
    public function insertUsuario(
        ...
        // Se verifica si ya existe la identificación o el email
    ...
    public function updateUsuario(
        ...
        // Verificamos si el email o identificación ya pertenecen a OTRO usuario diferente
        ...
        if (empty($request)) {
            // CORREGIDO: Se arregló "idepersona" por "idpersona" en ambos WHERE
            if ($this->strPassword != "") {
